...
public class SearchController {
    ...
    @GetMapping("/history")
    public ResponseEntity<ApiResponse<List<SearchHistoryRecord>>> getSearchHistory(
        ...
        List<SearchHistoryRecord> data = searchService.getSearchHistory(userId);
    ...
    @GetMapping("/courses")
    public ResponseEntity<ApiResponse<List<CourseSearchResultRecord>>> searchCourses(
            @Parameter(hidden = true) @CookieValue(name = "accessToken") String accessToken,
        ...
        List<CourseSearchResultRecord> data = searchService.searchCourses(userId, keyword, sort);
        return ResponseEntity.ok(ApiResponse.success(data));
    }
