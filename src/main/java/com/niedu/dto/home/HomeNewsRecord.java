...
public record HomeNewsRecord(
        @Schema(description= "ID (Course ID)")
        Long id,
    ...
    public HomeNewsRecord(Long id, String thumbnailUrl, String title, String publisher) {
        this(id, thumbnailUrl, title, publisher, null);
    }
